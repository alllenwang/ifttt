					...
					<div class="content-inner no-stream-end">
						<form id="profile-form" class="form-horizontal" method="POST"
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="task[name]" maxlength="20" type="text"
										name="task[name]" placeholder="Type in a name" value="<%= taskname %>" readonly>
									<p>任务名不能重复</p>
								</div>
							</fieldset>
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[dateday]" name="this[dateday]" type="text"
										placeholder="yyyy-MM-dd" value="<%= TableTaskDateMail.date(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[datetime]" name="this[datetime]" type="text"
										placeholder="hh-mm-ss" value="<%= TableTaskDateMail.time(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailid]" name="that[mailid]" type="text"
										placeholder="ifttt@ifttt.com" value="<%= TableTaskDateMail.sendMailID(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailrecepients]" name="that[mailrecepients]"
										type="text" placeholder="00@ifttt.com,01@ifttt.com,..." value="<%= TableTaskDateMail.receiveMailID(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailsubject]" name="that[mailsubject]" type="text" value="<%= TableTaskDateMail.subject(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
								...
								<div id="user_description_box" class="controls">
									<textarea class="input-xlarge" id="that[mailcontent]"
										name="that[mailcontent]"><%= TableTaskDateMail.text(taskname) %></textarea>
									<p class="bio-label">
