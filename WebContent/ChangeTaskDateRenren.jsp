...
<% if (username == null)
	...
	if (tasktype.compareTo("DateRenren") != 0)
		response.sendRedirect("ManageTasks.jsp");
	%>
				...
				<div role="main" aria-labelledby="content-main-heading"
					...
					<div class="content-header">
						<div class="header-inner">
							...
							<p class="subheader">在选定的时间发人人状态</p>
						</div>
					</div>
					<div class="content-inner no-stream-end">
						<form id="profile-form" class="form-horizontal" method="POST"
								...
								<div class="controls">
									<div class="uploader-avatar clearfix">
										<img class="avatar size73" id="avatar_preview"
											...
											src="./IMAGE/renren_icon.png" alt="stan">
									</div>
								</div>
							</fieldset>
							...
							<input type="hidden" id="task[type]" name="task[type]" value="DateRenren">
							<hr>
							<fieldset class="control-group">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[dateday]" name="this[dateday]" type="text"
										...
										value="<%= TableTaskDateRenren.date(taskname)%>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[datetime]" name="this[datetime]" type="text"
										...
										value="<%= TableTaskDateRenren.time(taskname)%>">

								</div>
							</fieldset>
							<hr>
							<fieldset class="control-group">
								<label class="control-strong-label" for="user_location">发人人状态</label>

							</fieldset>

							<fieldset class="control-group">
								<label class="control-label" for="user_location">人人账号</label>
								<div class="controls">
									<input id="that[renrenid]" name="that[renrenid]" type="text"
										placeholder="ifttt@ifttt.com"
										value="<%= TableTaskDateRenren.RenrenID(taskname)%>">
								</div>
							</fieldset>
							<fieldset class="control-group">
								<label class="control-label" for="user_location">人人密码</label>
								<div class="controls">
									<input id="that[renrenpassword]" name="that[renrenpassword]"
										type="password">
								</div>
							</fieldset>
							<fieldset class="control-group">
								<label class="control-label" for="user_description">人人状态</label>
								<div id="user_description_box" class="controls">
									<textarea class="input-xlarge" id="that[renrencontent]"
										name="that[renrencontent]"><%= TableTaskDateRenren.text(taskname)%></textarea>
									<p class="bio-label">
										人人状态不得多于<strong>140</strong>个字。
									</p>
								</div>
							</fieldset>
