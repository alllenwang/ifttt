...
<% if (username == null)
	...
	if (tasktype.compareTo("DateWeibo") != 0)
		response.sendRedirect("ManageTasks.jsp");
	%>
...
<script src="http://tjs.sjs.sinajs.cn/open/api/js/wb.js?appkey=3531562058" type="text/javascript" charset="utf-8">
				...
				<div role="main" aria-labelledby="content-main-heading"
					...
					<div class="content-inner no-stream-end">
						<form id="profile-form" class="form-horizontal" method="POST"
							...
							<input type="hidden" id="task[type]" name="task[type]" value="DateWeibo">
							<hr>
							<fieldset class="control-group">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[dateday]" name="this[dateday]" type="text"
										...
										value="<%= TableTaskDateWeibo.date(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[datetime]" name="this[datetime]" type="text"
										...
										value="<%= TableTaskDateWeibo.time(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[weiboid]" name="that[weiboid]" type="text"
										...
										value="<%= TableTaskDateWeibo.weiboID(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
							...
							<fieldset class="control-group">
								...
								<div id="user_description_box" class="controls">
									<textarea class="input-xlarge" id="that[weibocontent]"
										name="that[weibocontent]"><%= TableTaskDateWeibo.text(taskname) %></textarea>
									<p class="bio-label">
