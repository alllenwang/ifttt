...
<% if (username == null)
	...
	if (tasktype.compareTo("MailMail") != 0)
		response.sendRedirect("ManageTasks.jsp");
	%>
				...
				<div role="main" aria-labelledby="content-main-heading"
					...
					<div class="content-inner no-stream-end">
						<form id="profile-form" class="form-horizontal" method="POST"
							...
							<input type="hidden" id="task[type]" name="task[type]" value="MailMail">
							<hr>
							<fieldset class="control-group">
								<label class="control-strong-label" for="user_location">检查邮件</label>
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[mailid]" name="this[mailid]" type="text"
										...
										value="<%= TableTaskMailMail.listenMailID(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailid]" name="that[mailid]" type="text"
										placeholder="ifttt@ifttt.com"
										value="<%= TableTaskMailMail.sendMailID(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
								<label class="control-label" for="user_location">邮箱密码</label>
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailrecepients]" name="that[mailrecepients]"
										...
										value="<%= TableTaskMailMail.receiveMailID(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailsubject]" name="that[mailsubject]" type="text"
										value="<%= TableTaskMailMail.subject(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
								...
								<div id="user_description_box" class="controls">
									<textarea class="input-xlarge" id="that[mailcontent]"
										name="that[mailcontent]"><%= TableTaskMailMail.text(taskname) %></textarea>
									<p class="bio-label">
