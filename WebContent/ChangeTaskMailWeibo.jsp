...
<% if (username == null)
	...
	if (tasktype.compareTo("MailWeibo") != 0)
		response.sendRedirect("ManageTasks.jsp");
	%>
				...
				<div role="main" aria-labelledby="content-main-heading"
					...
					<div class="content-inner no-stream-end">
						<form id="profile-form" class="form-horizontal" method="POST"
								...
								<div class="controls">
									<div class="uploader-avatar clearfix">
										<img class="avatar size73" id="avatar_preview"
											src="./IMAGE/gmail_icon.png" alt="stan"> <img
							...
							<input type="hidden" id="task[type]" name="task[type]" value="MailWeibo">
							<hr>
							<fieldset class="control-group">
								<label class="control-strong-label" for="user_location">检查邮箱</label>

							</fieldset>
							<fieldset class="control-group">
								<label class="control-label" for="user_location">邮箱账号</label>
								<div class="controls">
									<input id="this[mailid]" name="this[mailid]" type="text"
									placeholder="ifttt@ifttt.com"
										value="<%= TableTaskMailWeibo.listenMailID(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[mailpassword]" name="this[mailpassword]" type="password">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[weiboid]" name="that[weiboid]" type="text"
										placeholder="ifttt@ifttt.com"
										value="<%= TableTaskMailWeibo.weiboID(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
							...
							<fieldset class="control-group">
								...
								<div id="user_description_box" class="controls">
									<textarea class="input-xlarge" id="that[weibocontent]"
										name="that[weibocontent]"><%= TableTaskMailWeibo.text(taskname) %></textarea>
									<p class="bio-label">
