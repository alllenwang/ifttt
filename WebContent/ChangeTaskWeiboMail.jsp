...
<% if (username == null)
	...
	if (tasktype.compareTo("WeiboMail") != 0)
		response.sendRedirect("ManageTasks.jsp");
	%>
				...
				<div role="main" aria-labelledby="content-main-heading"
					...
					<div class="content-inner no-stream-end">
						<form id="profile-form" class="form-horizontal" method="POST"
							...
							<input type="hidden" id="task[type]" name="task[type]" value="WeiboMail">
							<hr>
							<fieldset class="control-group">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="this[weibopassword]" name="this[weibopassword]" type="password">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailid]" name="that[mailid]" type="text"
										placeholder="ifttt@ifttt.com"
										value="<%= TableTaskWeiboMail.sendMailID(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailrecepients]" name="that[mailrecepients]"
										...
										value="<%= TableTaskWeiboMail.receiveMailID(taskname) %>">
							...
							<fieldset class="control-group">
								...
								<div class="controls">
									<input id="that[mailsubject]" name="that[mailsubject]" type="text"
										value="<%= TableTaskWeiboMail.subject(taskname) %>">
								</div>
							</fieldset>
							<fieldset class="control-group">
								...
								<div id="user_description_box" class="controls">
									<textarea class="input-xlarge" id="that[mailcontent]"
										name="that[mailcontent]"><%= TableTaskWeiboMail.text(taskname) %></textarea>
									<p class="bio-label">
