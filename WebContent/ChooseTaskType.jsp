...
<meta charset="utf-8">
<title>ChooseTaskType</title>
<meta name="swift-page-name" id="swift-page-name" content="settings">
<link rel="stylesheet" href="./CUSTOMED/ChooseTaskType.css" type="text/css">
				...
				<div role="main" aria-labelledby="content-main-heading"
					...
					<div class="content-header">
						<div class="header-inner">
							<h2 id="content-main-heading">选择任务类型</h2>
					...
					<div class="content-inner no-stream-end">
						<div id="profile-form" class="form-horizontal">
							...
							<fieldset id="profile-image-controls" class="control-group">
								<label class="control-label" for="profile_image_uploaded_data">null</label>
								<a href="./CreateTaskDateMail.jsp">
									<div class="controls">
							...
							<fieldset id="profile-image-controls" class="control-group">
								<label class="control-label" for="profile_image_uploaded_data">null</label>
								<a href="./CreateTaskMailWeibo.jsp">
									<div class="controls">
										<div class="uploader-avatar clearfix">
											<img class="avatar size73" id="avatar_preview"
							...
							<fieldset id="profile-image-controls" class="control-group">
								<label class="control-label" for="profile_image_uploaded_data">null</label>
								<a href="./CreateTaskDateRenren.jsp">
									<div class="controls">
										<div class="uploader-avatar clearfix">
											<img class="avatar size73" id="avatar_preview"
												src="./IMAGE/clock_icon.png" alt="stan"> <img
							...
							<fieldset id="profile-image-controls" class="control-group">
								<label class="control-label" for="profile_image_uploaded_data">null</label>
								<a href="./CreateTaskDateWeibo.jsp">
									<div class="controls">
										<div class="uploader-avatar clearfix">
											<img class="avatar size73" id="avatar_preview"
												src="./IMAGE/clock_icon.png" alt="stan"> <img
							...
							<fieldset id="profile-image-controls" class="control-group">
								<label class="control-label" for="profile_image_uploaded_data">null</label>
								<a href="./CreateTaskWeiboMail.jsp">
									<div class="controls">
										<div class="uploader-avatar clearfix">
											<img class="avatar size73" id="avatar_preview"
							...
							<fieldset id="profile-image-controls" class="control-group">
								<label class="control-label" for="profile_image_uploaded_data">null</label>
								<a href="./CreateTaskWeiboWeibo.jsp">
									<div class="controls">
										<div class="uploader-avatar clearfix">
											<img class="avatar size73" id="avatar_preview"
												src="./IMAGE/weibo_icon.png" alt="stan"> <img
							...
							<!-- <fieldset class="control-group">
								<div class="form-actions">
									...
									<button class="btn" type="button"
										onclick="location.herf&#39;Welcome.html&#39;">取消</button>
								</div>
							</fieldset> -->
